...
public class HSQLLifeCycle implements WebApplicationLifecycle {
    ...
    private void createTables(){
        ...
        try {
            statement = hibernateDaoHelper.getConnection().createStatement();
            // create todo
            statement.executeUpdate("create table t_todo (id bigint GENERATED BY DEFAULT AS IDENTITY(START WITH 1) not null primary key,name varchar(100),done boolean)");
